...
[核心功能](#核心功能) · [界面预览](#界面预览) · [快速开始](#快速开始) · [导入与分析](#导入与分析) · [增长工作台](#增长工作台) · [Skill 与 MCP](#skill-与-mcp) · [开发](#开发)

![运营总览](docs/qa/overview-desktop.png)

## 核心功能

- **增长工作台**：千帆订单字段映射、订单量与净 GMV 同比、学校/学院/商品分组、异常与行为线索关联。
...
3. 登记内容资产，依据已审核事件、招生规模、转化率和客单价测算预算，提交投放或充值方案。
